...
public sealed record ScientificWorkWithDetailsDto
{
...
public sealed record StudentDto1
{
    public Guid IsnStudent { get; init; }
    public string FullName { get; init; }
}

public sealed record SubjectDto1
{
    public Guid IsnSubject { get; init; }
    public string Name { get; init; }
}

public sealed record WorkReferenceDto
{
