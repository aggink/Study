...
public sealed record CreateMuseumVisitorDto
{
    /// <summary>
    /// Имя
    /// </summary>
    ...
    /// <summary>
    /// Тип билета (Взрослый, Детский, Студенческий, Пенсионный, Групповой, VIP)
    /// </summary>
    [Required]
    [MaxLength(ModelConstants.MuseumVisitor.TicketType)]
    public string TicketType { get; init; } = "Взрослый";
