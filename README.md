...
- [📌 Лабораторная работа 3](#лабораторная-работа-3)
  - [📝 Задание: Разработать API, реализующее CRUD](#лаба-3-задание-1)
