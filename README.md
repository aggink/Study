...
### 🔹 Основные компоненты:  
- **`Study`** – основной исполняемый проект, содержащий точку входа (`Program.cs`).  
...
- **`Study.Lab1.UnitTests`** – проект с тестами, позволяющий проверить корректность работы реализованных решений.  
...
Юнит-тесты создаются в проекте **`Study.Lab1.UnitTests`**, который уже существует в вашем проекте. Для каждого задания, реализованного в вашем сервисе, необходимо создать отдельные тесты.

### 🔹 Структура тестов:
1. В проекте **`Study.Lab1.UnitTests`** создайте папку с вашим никнеймом.
