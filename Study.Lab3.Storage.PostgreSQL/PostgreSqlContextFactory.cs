...
{
    private const string DbConnectionString = "Host=localhost:5432;Database=Study;Username=postgres;Password=sissy;CommandTimeout=20;Timeout=40;Include Error Detail=True";
