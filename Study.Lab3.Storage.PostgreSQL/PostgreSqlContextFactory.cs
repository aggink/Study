...
{
    private const string DbConnectionString = "Host=localhost:5432;Database=Study;Username=user_developer;Password=user_developer;CommandTimeout=20;Timeout=40;Include Error Detail=True";
