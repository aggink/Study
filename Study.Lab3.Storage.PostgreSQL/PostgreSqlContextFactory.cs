...
{
    private const string DbConnectionString = "Host=localhost:54320;Database=Study;Username=postgres;Password=qwerty;CommandTimeout=20;Timeout=40;Include Error Detail=True";
