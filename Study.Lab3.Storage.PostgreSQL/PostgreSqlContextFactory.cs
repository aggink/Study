...
{
    private const string DbConnectionString = "Host=localhost:5432;Database=postgres;Username=postgres;Password=kirill3a8;CommandTimeout=20;Timeout=40;Include Error Detail=True";
