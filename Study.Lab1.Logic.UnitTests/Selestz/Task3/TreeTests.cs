...
namespace Study.Lab1.Logic.UnitTests.Selestz.Task3;
...
public class TreeTests
{
    ...
    [Test]
    public void GetTree_NoChildren_ReturnsEmptyString()
    {
        var node = new TreeNode<string>("Root");
    ...
    [Test]
    public void GetTree_WithChildren_ReturnsFormattedString()
    {
        var root = new TreeNode<string>("Root");
        var child1 = new TreeNode<string>("Child1");
        var child2 = new TreeNode<string>("Child2");
    ...
    [Test]
    public void GetTree_WithNestedChildren_ReturnsCorrectHierarchy()
    {
        var root = new TreeNode<string>("Root");
        var child1 = new TreeNode<string>("Child1");
        var child2 = new TreeNode<string>("Child2");
    ...
    [Test]
    public void GetTree_DeepNesting_IncrementsIndentationCorrectly()
    {
        var root = new TreeNode<string>("Root");
    ...
    [Test]
    public void GetTree_ComplexTree_ReturnsCorrectStructure()
    {
